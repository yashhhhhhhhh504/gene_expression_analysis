...
gset <- getGEO("GSE80796", GSEMatrix =TRUE, AnnotGPL=TRUE)
...
gsms <- paste0("000101001000101000000111101XX11XXXXX1X1X11XXXXXX1X",
...
gs <- factor(sml)
groups <- make.names(c("cancer","no cancer"))
levels(gs) <- groups
gset$group <- gs
...
par(mar=c(7,4,2,1))
title <- paste ("GSE80796", "/", annotation(gset), sep ="")
